# AnyFind — notas de desarrollo

Bitácora interna del mod: el plan del escaneo, las decisiones que se tomaron y por qué, la hoja
de ruta y el registro de cambios. Para la descripción del mod, ver el [README](README.md).
...
MIT — ver [LICENSE.txt](LICENSE.txt). Cualquiera puede usar, modificar y redistribuir el código,
incluso en un modpack o en un proyecto comercial, siempre que mantenga el aviso de copyright.
